...
-   Bump [@bandyer/web-core-av](https://www.npmjs.com/package/@bandyer/web-core-av) to 1.20.1 version
...
-   Fix user details provider
-   Fix avatar in window mode
...
-   Fix uploads and feedback in US and IN
