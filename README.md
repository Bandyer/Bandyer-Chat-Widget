...
<head></head>
	<body>
	<script src="https://cdn.bandyer.com/sdk/js/chat/1.41.6/bandyer-widget.min.js" type="text/javascript" >
	</script>
	</body>
</html>
```
...
Latest version available is: 1.41.6
[https://cdn.bandyer.com/sdk/js/chat/1.41.6/bandyer-widget.min.js](https://cdn.bandyer.com/sdk/js/chat/1.41.6/bandyer-widget.min.js)
