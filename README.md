...
<head></head>
	<body>
	<script src="https://cdn.bandyer.com/sdk/js/chat/1.19.5/bandyer-widget.min.js" type="text/javascript" >
	</script>
	</body>
</html>
```
...
Latest version available is: 1.19.5.
[https://cdn.bandyer.com/sdk/js/chat/1.19.5/bandyer-widget.min.js]()
