...
<head></head>
	<body>
	<script src="https://cdn.bandyer.com/sdk/js/chat/1.26.3/bandyer-widget.min.js" type="text/javascript" >
	</script>
	</body>
</html>
```
...
Latest version available is: 1.26.3
[https://cdn.bandyer.com/sdk/js/chat/1.26.3/bandyer-widget.min.js]()
