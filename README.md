...
<head></head>
<body>
<script src="https://cdn.bandyer.com/sdk/js/chat/2.0.0-beta.0/bandyer-widget.min.js" type="text/javascript" >
</script>
</body>
</html>
```
...
The latest version is: 2.0.0-beta.0
[https://cdn.bandyer.com/sdk/js/chat/2.0.0-beta.0/bandyer-widget.min.js](https://cdn.bandyer.com/sdk/js/chat/2.0.0-beta.0/bandyer-widget.min.js)
