...
<head></head>
	<body>
	<script src="https://cdn.bandyer.com/sdk/js/chat/1.39.1/bandyer-widget.min.js" type="text/javascript" >
	</script>
	</body>
</html>
```
...
Latest version available is: 1.39.1
[https://cdn.bandyer.com/sdk/js/chat/1.39.1/bandyer-widget.min.js](https://cdn.bandyer.com/sdk/js/chat/1.39.1/bandyer-widget.min.js)
